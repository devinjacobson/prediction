...
for r=-0.2:0.01:0.2
    count=count+1
    for i=1:100
        pars.p_X=[0.1+r/2 0.3-r/2 0.15-r/2 0.45+r/2];pars.X_values=[-3;-1;1;3];
        pars2.p_n=[0.2 0.5 0.3];pars2.n_values=[-2;0;2];
        [X Y]=add_noise(200,[1;2;1;2],'custom',pars,'custom',pars2,'vector');
        
        %[X Y]=add_noise(200, [3;1;2;0], [0.6 0.1 0.1 0.2], [r/2 r/2 0.5-r/2 0.5-r/2]);
