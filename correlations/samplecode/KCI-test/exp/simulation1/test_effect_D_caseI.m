...
for iter = 1:It_max
    ...
    [tmp1, tmp2, tmp3, tmp4, tmp5] =...
        CInd_test_new_withGP(x, y, [z normrnd(0,1,T,1)], 0.01, Width);
    ...
    [tmp1, tmp2, tmp3, tmp4, tmp5] =...
        CInd_test_new_withGP(x, y, [z normrnd(0,1,T,2)], 0.01, Width);
    %     [tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9] =...
    %         CInd_test_new_withGP(x, y, [z], 0.01, Width);
    ...
    [tmp1, tmp2, tmp3, tmp4, tmp5] =...
        CInd_test_new_withGP(x, y, [z normrnd(0,1,T,3)], 0.01, Width);
    Sta_4(iter) = tmp1; Cri_4(iter) = tmp2; p_val_4(iter) = tmp3; Cri_appr_4(iter) = tmp4;
    p_appr_4(iter) = tmp5;
    % on five variables
    [tmp1, tmp2, tmp3, tmp4, tmp5] =...
        CInd_test_new_withGP(x, y, [z normrnd(0,1,T,4)], 0.01, Width);
    %     [tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9] =...
    %         CInd_test_new_withGP(x, y, [z], 0.01, Width);
