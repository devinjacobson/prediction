function varargout = IcaGuiApecs(varargin);

% ICAGUIAPECS M-file for IcaGuiApecs.fig
%
%      ICAGUIAPECS, by itself, creates a new ICAGUIAPECS or raises the existing
%      singleton.
%
%      H = ICAGUIAPECS returns the handle to a new ICAGUIAPECS or the handle to
%      the existing singleton*.
%
%      ICAGUIAPECS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ICAGUIAPECS.M with the given input arguments.
%
%      ICAGUIAPECS('Property','Value',...) creates a new ICAGUIAPECS or raises
%      the existing singleton.  Starting from the left, property value pairs are
%      applied to the GUI before IcaGuiApecs_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to IcaGuiApecs_OpeningFcn via varargin.
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @IcaGuiApecs_OpeningFcn, ...
                   'gui_OutputFcn',  @IcaGuiApecs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before IcaGuiApecs is made visible.

function IcaGuiApecs_OpeningFcn(hObject, eventdata, handles, varargin);

% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to IcaGuiApecs (see VARARGIN)
...
sigClean.numChan = varargin{5}      ;
sigClean.numSmpl = varargin{6}      ;
...
if varargin{7}
    ...
    switch sigClean.icaProtocol
        ...
        case 2
            ...
            sigClean.sphFilePath  =  sigClean.scfPath   ;
            sigClean.sphFileName  = 'Apecs.sph'         ;
...
function varargout = IcaGuiApecs_OutputFcn(hObject, eventdata, handles);
...
if ~sigClean.wgtMtrxOutput || sigClean.sphMtrxOutput
...
if (sigClean.mixMtrxOutput || sigClean.unMixMtrxOutput || sigClean.iCMtrxOutput)
    ...
    case 1
        ...
        switch sigClean.wgtMtrx
            ...
            case 1
                ...
                sigClean.wgtFilePath  =  sigClean.scfPath;
                sigClean.wgtFileName  =  'Apecs.wgt';
...
set( [ handles.SphMtrxPopUp,        ...
       handles.ValWhitenChkBox,     ...
       handles.DoNotWhitenButton ], ...
                                    ...
	   'Enable', 'Inactive',        ...
       'ForegroundColor', [0.4 0.4 0.4] );

set( handles.IcaGuiApecs,   ...
                            ...
...
set( [ handles.ChanEditBox,                                         ...
       ...
       { 'Inactive' , [0.4 0.4 0.4] , int2str(sigClean.numChan) ;   ...
         ...
         'Inactive' , [0.4 0.4 0.4] , '<<<< Running HiPerSAT Via APECS >>>' } );
